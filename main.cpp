...
void drawScreensaver()
{
    ...
    txDrawText(240,405,480,470,"ÏÐÅÄÑÒÀÂËßÅÒ");
}
void drawScreensaver2()
{
    ...
    txSetColor (TX_RED);
    txSetFillColor (TX_RED);
    txDrawText(180,60,560,130,"CÌÅØÍÛÅ,ÐÎÍÄÎÌÍÛÅ ÌÎÌÅÍÒÛ");
    txDrawText(240,80,480,150,"ÈÇ Ê.Ñ");
}
...
void drawDiologKt()
 {
txDrawText(10,390,250,430,"Åù¸ îäèí èçè ôðàã :3");
 }
...
void drawKtDied()
{
    ...
    txTextOut(560,490,"Õ-Õ");
}

void drawDiologMarmok()
 {
   txSetColor(TX_GREEN, 3);
   txDrawText(595,375,780,410,"ÐÀÒÀÒÀÒÀÒÀ");
 }
...
{
   txSetColor(TX_GREEN, 3);
   txDrawText(200,y-300,550,y-250,"ÑÏÎÍÑÎÐ-HAZBIHcompany");
   txSetColor(TX_BLUE, 3);
   txDrawText(200,y-200,550,y-150,"ÑÖÓÍÀÐÈÑÒ-ÂÀÍÅÊ_ÀÐÒÅØÎÊ");
   txSetColor(TX_GRAY, 3);
   txDrawText(200,y-50,550,y,"ÀÔÒÎÐ ÈÄÅÈ-Ìàðèí(Ìàðìîê)");
   txSetColor(TX_RED, 3);
   txDrawText(210,y-100,560,y-50,"ÀÍÈÌÀÒÎÐ-ÂÀÍÅÊ_ÀÐÒÅØÎÊ");
   txSetColor(TX_PINK, 3);
   txDrawText(200,y+100,550,y+150,"ÕÓÄÎÆÍÈÊ-ÌEÄß");
...
int main()
    ...
    HDC Smile = txLoadImage ("èñïóã.bmp");
    HDC Avatar2= txLoadImage ("ñìàéë.bmp");
    HDC Avatar= txLoadImage ("àâàòàðêà.bmp");
    HDC Mush= txLoadImage ("ïîìåõè.bmp");
    HDC Beginning3= txLoadImage ("ôîí3.bmp");
    HDC Beginning2= txLoadImage ("ôîí2.bmp");
    HDC Beginning= txLoadImage ("ôîí.bmp");
    HDC Akr2 = txLoadImage ("ÊÎËÀØ2.bmp");
    HDC Akr = txLoadImage ("ÊÎËÀØ.bmp");
    {
     drawScreensaver();
     drawAvatar(Avatar);
