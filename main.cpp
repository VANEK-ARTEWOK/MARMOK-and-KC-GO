...
void drawScreensaver()
{
    ...
    txDrawText(240,405,480,470,"œ–≈ƒ—“¿¬Àﬂ≈“");
}
...
void drawDiologKt()
 {
txDrawText(10,390,250,430,"≈˘∏ Ó‰ËÌ ËÁË Ù‡„ :3");
 }
...
{
   txSetColor(TX_GREEN, 3);
   txDrawText(200,40,550,90,"—œŒÕ—Œ–-HAZBIHcompany");
   txSetColor(TX_BLUE, 3);
   txDrawText(200,375,780,410,"—÷”Õ¿–»—“-¬¿Õ≈ _¿–“≈ÿŒ ");
   txSetColor(TX_GRAY, 3);
   txDrawText(200,375,780,410,"¿‘“Œ– »ƒ≈»-Ã‡ËÌ");
   txSetColor(TX_RED, 3);
   txDrawText(200,375,780,410,"¿Õ»Ã¿“Œ–-¬¿Õ≈ _¿–“≈ÿŒ ");
   txSetColor(TX_PINK, 3);
   txDrawText(200,375,780,410,"’”ƒŒ∆Õ» -Ã”ƒﬂ");
